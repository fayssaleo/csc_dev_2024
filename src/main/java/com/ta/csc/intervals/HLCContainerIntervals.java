...
public class HLCContainerIntervals {
    public static List<Interval> fullTransshipmentIntervals() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 8, 0);
        Interval secondInterval = new Interval(9, 15, 3.02);
        Interval thirdInterval = new Interval(16, 28, 3.75);
        Interval fourthInterval = new Interval(29, 1000000, 5.61);
    ...
    public static List<Interval> fullTransshipmentIntervals2021() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 8, 0);
        Interval secondInterval = new Interval(9, 15, 2.95);
        Interval thirdInterval = new Interval(16, 28, 3.66);
        Interval fourthInterval = new Interval(29, 1000000, 5.48);
    ...
    public static List<Interval> fullTransshipmentIntervals2023() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 8, 0);
        Interval secondInterval = new Interval(9, 15, 3.12);
        Interval thirdInterval = new Interval(16, 28, 3.88);
        Interval fourthInterval = new Interval(29, 1000000, 5.80);
    ...
    public static List<Interval> fullTransshipmentIntervals2024() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 8, 0);
        Interval secondInterval = new Interval(9, 15, 3.12);
        Interval thirdInterval = new Interval(16, 21, 6);
        Interval fourthInterval = new Interval(22, 28, 15);
        Interval fifthInterval = new Interval(29, 1000000, 30);
    ...
    public static List<Interval> fullReeferTransshipmentIntervals() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 5, 0);
        Interval secondInterval = new Interval(6, 15, 4.01);
        Interval thirdInterval = new Interval(16, 30, 4.97);
        Interval fourthInterval = new Interval(31, 1000000, 7.58);
    ...
    public static List<Interval> fullReeferTransshipmentIntervals2021() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 5, 0);
        Interval secondInterval = new Interval(6, 15, 3.92);
        Interval thirdInterval = new Interval(16, 30, 4.85);
        Interval fourthInterval = new Interval(31, 1000000, 7.40);
    ...
    public static List<Interval> fullReeferTransshipmentIntervals2023() {
        List<Interval> intervals = new ArrayList<>();
        Interval firstInterval = new Interval(1, 5, 0);
        Interval secondInterval = new Interval(6, 15, 4.14);
        Interval thirdInterval = new Interval(16, 30, 5.14);
        Interval fourthInterval = new Interval(31, 1000000, 7.83);
    ...
    public static List<Interval> fullReeferTransshipmentIntervals2024() {
        List<Interval> intervals = new ArrayList<>();
